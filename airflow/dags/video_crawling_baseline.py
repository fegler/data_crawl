...
from pipeline_logic.video.preprocess import split_raw_to_segments_single, save_clip_with_sampling

@dag(
    dag_id="youtube_base_pipeline",
    schedule=None,
    catchup=False,
    ...
    params={
        ...
        "seg_duration": Param(2, type="integer"),
        "sample_rate": Param(2, type="integer"),
    }
)
